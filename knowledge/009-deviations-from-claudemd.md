...
`CLAUDE.md`'s inline directory tree was removed and replaced with a pointer to [008](008-directory-layout.md). Rationale paragraphs (Kivy, CSV, PNG, minimal toolset) were extracted into dedicated notes ([010](010-kivy-over-beeware.md), [011](011-csv-for-area-output.md), [012](superseded/012-png-label-maps.md), [013](013-minimal-toolset.md)). Behavioral rules, core-concept contracts, cross-platform notes, and definition-of-done remain in `CLAUDE.md`.
...
- **Collision policy scope clarified.** [021](superseded/021-vertex-edit-collision.md) renamed from "Vertex-Edit Collision Policy" to "Edit Collision Policy"; applies to add strokes now, not handle drags.
